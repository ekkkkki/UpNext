...
/// `QuickAdd --selftest-eventkit`. Exit codes: 0 pass, 1 fail, 2 skipped (no access).
@MainActor
enum IntegrationSelfTest {
    static let marker = "QuickAdd self-test ✓"
    ...
    static let resultPath = "/tmp/quickadd_selftest_result.txt"
